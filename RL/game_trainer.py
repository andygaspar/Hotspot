...
class TFAgentTrainer:
	...
	def build_game_wrapper(self, gym_env):
		...
		self.lims_simple = gym_env.lims_simple
		self.lims_triple = gym_env.lims_triple

		self.observation_specs = split_bounded_tensor_spec(self.observation_spec, lims=gym_env.lims_triple)
		self.action_specs = split_bounded_tensor_spec(self.action_spec, lims=gym_env.lims_simple)
		self.time_step_specs = split_time_step_spec(self.time_step_spec, lims=gym_env.lims_triple)
